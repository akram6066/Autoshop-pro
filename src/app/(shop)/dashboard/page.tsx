      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between mb-8">
        <div>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <h1 className="text-2xl sm:text-3xl font-bold text-[var(--color-ink-primary)] tracking-tight">
              Dashboard
            </h1>
        ...
        <div className="flex gap-2 sm:flex-shrink-0">
          <Link
            href="/inventory/new"
            className="flex-1 sm:flex-none text-center px-4 py-2 bg-[var(--color-surface-2)] hover:bg-[var(--color-surface-3)] text-[var(--color-ink-primary)] font-medium rounded-xl border border-[var(--color-border-subtle)] transition-colors shadow-sm text-sm"
          >
            Add Product
          </Link>
          <Link
            href="/pos"
            className="flex-1 sm:flex-none text-center px-4 py-2 bg-brand-600 hover:bg-brand-500 text-white font-bold rounded-xl transition-colors shadow-[0_0_15px_rgba(99,102,241,0.3)] text-sm"
          >
            New Sale
          </Link>
        </div>
