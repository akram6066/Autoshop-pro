        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[var(--color-surface-1)] border-b border-[var(--color-border-subtle)] text-xs uppercase tracking-wider text-[var(--color-ink-secondary)] font-semibold">
              ...
              <th className="px-4 sm:px-6 py-3 sm:py-4 text-right">Stock</th>
              <th className="px-4 sm:px-6 py-3 sm:py-4 text-right">Min</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[var(--color-border-subtle)]">
            {items.map((product) => (
              ...
              >
                ...
                <td className="px-4 sm:px-6 py-3 sm:py-4 text-right text-[var(--color-ink-secondary)] text-sm">
                  {product.min_stock}
                </td>
              </tr>
            ))}
