...
import { Package, Building2, ArrowRight, Zap } from "lucide-react";
        ...
        <div className="flex flex-col gap-24 md:gap-32 lg:gap-40 px-2 sm:px-0">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 relative">
            <div className="lg:w-1/2 flex flex-col items-start z-10">
              ...
              <p className="text-base sm:text-lg text-zinc-400 mb-8 max-w-lg leading-relaxed">
                Your line should never stall. AutoShop Pro’s POS is engineered
                for extreme speed. Scan barcodes, process partial payments, and
                print receipts in milliseconds—even when your internet
                connection drops.
              </p>
              ...
              <ul className="flex flex-col gap-5 mb-10">
                {[
                  ...
                  "Split payments & credit tracking",
                ].map((item, i) => (
                  <li
                    key={i}
              ...
              <Link
                href="/signup"
                className="group flex items-center gap-2 text-brand-400 font-semibold hover:text-brand-300 transition-colors"
              >
                Experience the POS{" "}
                <ArrowRight
                  size={18}
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-16 relative">
            <div className="lg:w-1/2 flex flex-col items-start z-10">
              ...
              <p className="text-base sm:text-lg text-zinc-400 mb-8 max-w-lg leading-relaxed">
                Stop losing money to dead stock and missing parts. Track every
                tire, battery, and liter of oil across your entire operation
                with real-time accuracy and automated predictive reordering.
              </p>
            ...
            <div className="lg:w-1/2 relative w-full perspective-1000">
              ...
              <ParallaxFloat
                ...
                direction={1.2}
                offset={-20}
                className="hidden md:block absolute top-12 -right-12 z-20"
              >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 relative">
            <div className="lg:w-1/2 flex flex-col items-start z-10">
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-[1.15] sm:leading-[1.1] tracking-tight">
                One powerful system controlling{" "}
              ...
              <p className="text-base sm:text-lg text-zinc-400 mb-8 max-w-lg leading-relaxed">
                Whether you have two shops or twenty, manage them all from a
                single dashboard. Compare branch performance, transfer stock
                effortlessly, and standardize pricing globally.
              </p>
            ...
            <div className="lg:w-1/2 relative w-full perspective-1000">
              <ParallaxMockup scrollYProgress={scrollYProgress} direction={1.1}>
                <Image
                  src="/sales dark mode.png"
                  alt="Sales and Reporting"
                  width={1200}
                  height={800}
                  className="w-full h-auto object-cover rounded-2xl"
                />
...
function ParallaxFloat({
  ...
  const y = useTransform(
    scrollYProgress,
    [0, 1],
    [-80 * direction + offset, 80 * direction + offset],
  );
