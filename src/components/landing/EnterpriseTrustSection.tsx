...
import { Shield, WifiOff, Globe2, Activity, Database, Server, RefreshCcw } from "lucide-react";
...
const features = [
  {
    ...
    description: "Keep selling even when your internet drops. AutoShop Pro stores data locally in IndexedDB and syncs perfectly when the connection returns.",
  ...
  },
  {
    ...
    description: "Every sale and stock adjustment is instantly reflected across all your devices.",
...
function BentoCard({ feature, delay }: { feature: any, delay: number }) {
  ...
  return (
    ...
    >
      ...
      {/* Subtle Inner Glow */}
      <div className={`absolute inset-0 opacity-0 group-hover:opacity-10 transition-opacity duration-700 bg-gradient-to-br ${feature.color} z-0`}></div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-end gap-10 mb-20">
          ...
          <div className="max-w-sm pb-2">
            <p className="text-lg text-zinc-400 font-medium">
              Your software should be as reliable as the vehicles you service. Engineered for extreme stability.
            </p>
          </div>
        </div>
