...
-- 2. Create a unique index on invoice_number
-- (Using IF NOT EXISTS in case we run this multiple times)
CREATE UNIQUE INDEX IF NOT EXISTS sales_invoice_number_idx ON public.sales (invoice_number);

-- 3. Update get_sales_with_staff to return invoice_number
...
-- 4. Update record_sale to handle invoice_number
